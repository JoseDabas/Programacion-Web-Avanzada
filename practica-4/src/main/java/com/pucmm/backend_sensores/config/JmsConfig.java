...
/**
 * Clase de configuración para habilitar y ajustar Jakarta Messaging (JMS) en
 * Spring Boot.
 * La anotación @EnableJms le dice a Spring que busque componentes que tengan
 * métodos
...
public class JmsConfig {
     ...
     *
     * @param connectionFactory La fábrica de conexiones inyectada dinámicamente
     *                          hacia el ActiveMQ local
