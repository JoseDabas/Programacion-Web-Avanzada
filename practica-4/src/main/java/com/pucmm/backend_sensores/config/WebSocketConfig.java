 ...
 * La anotación @EnableWebSocketMessageBroker habilita el servidor broker de
 * mensajes,
 * el cual es usado para crear comunicación bidireccional en tiempo real entre
 * el servidor y clientes web.
 */
@Configuration
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    /**
     * Registra los endpoints a los que los clientes (frontend) se conectarán
     * inicialmente.
     * En este caso, el cliente establecerá la conexión con la ruta HTTP
     * "/ws-sensores".
     */
    @Override
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        ...
        // Define el prefijo usado cuando el cliente envía mensajes expresamente hacia
